...
export default function BatchDetailsPage() {
  ...
  const handleConfirmProduction = () => {
    ...
    toast({
        ...
        description: `${selectedItems.size} items have been marked as 'produced'.`
    });
    setSelectedItems(new Set());
  }
  ...
  const handleUnlinkItems = () => {
    ...
    toast({
        title: "Items Unlinked",
        description: `${selectedItems.size} items have been returned to the pending pool.`,
        variant: "destructive"
    });
    setSelectedItems(new Set());
  }
  ...
  return (
    <>
      <PageHeader
        ...
        description={`Manage the items within production batch #${batch.batchNumber}.`}
      >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select items to confirm production or unlink them from this batch.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TableBody>
                {batchItems.map((detail) => (
                  ...
                  >
                    ...
                    <TableCell>
                        <Badge variant={detail.isProduced ? 'default' : 'outline'}>{detail.isProduced ? 'Produced' : 'Pending'}</Badge>
                    </TableCell>
                  </TableRow>
                ))}
                 {batchItems.length === 0 && (
