...
export default function GenerateCompleteRemitoPage() {
  ...
  const itemsToDispatch = useMemo(() => orderDetails.filter((od) => od.orderId === orderId && od.status === 'produced'), [orderId]);

  if (!order || !client || itemsToDispatch.length === 0) {
    notFound();
  }
  ...
  return (
    <>
      <div className="no-print mb-8 flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Generar Remito</h1>
        ...
        <CardHeader className="p-6">
            <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                    <h1 className="text-3xl font-bold text-primary">REMITO</h1>
                    <p className="font-semibold">N° 0001-00001234</p>
